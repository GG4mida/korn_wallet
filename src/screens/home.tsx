      ...
      <View style={tailwind('p-4')}>
        <View style={tailwind('bg-yellow-600 rounded-xl')}>
          <View style={tailwind('p-5')}>
            ...
            <View
              ...
              <Text style={tailwind('text-sm text-white')}>0.223131</Text>
            </View>
          </View>

          <View
            style={tailwind(
              'bg-yellow-500 px-10 py-4 rounded-b-xl flex flex-row justify-between items-center',
            )}>
            <View style={tailwind('flex flex-row items-center')}>
              ...
              />
              <Text style={tailwind('text-gray-100 text-sm ml-2')}>转账</Text>
            </View>
            ...
            <View style={tailwind('flex flex-row items-center')}>
              <Icon
                ...
                style={tailwind('text-gray-100')}
              />
              <Text style={tailwind('text-gray-100 text-sm ml-2')}>收款</Text>
            </View>
            ...
            <View style={tailwind('flex flex-row items-center')}>
              <Icon
                ...
                style={tailwind('text-gray-100')}
              />
              <Text style={tailwind('text-gray-100 text-sm ml-2')}>行情</Text>
            </View>
          </View>
        </View>

        <View style={tailwind('flex flex-row justify-between items-center')}>
          <Text style={tailwind('text-xl my-5 text-gray-700')}>资产</Text>
          <Icon
            name="plus-circle"
            size={20}
        ...
        <LinearGradient
          ...
          <View style={tailwind('flex flex-row justify-between')}>
            ...
            <View style={tailwind('items-end')}>
              <Text style={tailwind('text-gray-600 text-sm')}>2.331</Text>
        ...
        <LinearGradient
          ...
          <View style={tailwind('flex flex-row justify-between')}>
            ...
            <View style={tailwind('items-end')}>
              <Text style={tailwind('text-gray-600  text-sm')}>89.321321</Text>
              <Text style={tailwind('text-gray-800 text-lg')}>¥ 321321</Text>
            </View>
          </View>
        </LinearGradient>
