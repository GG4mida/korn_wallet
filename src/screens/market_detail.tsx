...
const HeaderRightComponent = () => {
  return (
    <View style={tailwind('flex flex-row items-center')}>
      <Icon name="star" size={18} color={getColor('gray-600')} />
    </View>
  );
};
...
//   return (
//     <View
//       style={tailwind('absolute h-full w-full items-center justify-center')}>
//       <ActivityIndicator />
//     </View>
//   );
// };

const MarketDetailScreen = ({}: any) => {
  const labels: string[] = [];
  const datas = [];
    ...
    <View style={tailwind('flex-1 bg-white')}>
      ...
      <View
        ...
        <View style={tailwind('flex flex-col items-end w-1/3')}>
          ...
          <View style={tailwind('flex flex-row items-center')}>
            <Text style={tailwind('text-base text-gray-800 italic mr-1')}>
              $
            </Text>
      ...
      <View
        style={tailwind(
          'flex flex-row items-center flex-wrap justify-between border-b border-gray-100 p-1',
        )}>
        <View
          style={tailwind(
        ...
        <View style={tailwind('bg-white rounded-xl p-4 mb-3')}>
          ...
          <View style={tailwind('mb-2')}>
            <Text style={tailwind('text-base text-gray-600')}>
              ...
              筹码分布从较为集中变为高度集中，筹码集中度上升。其中，68.08% 的
              USDT 集中于 Huobi 交易所。
            </Text>
          </View>
